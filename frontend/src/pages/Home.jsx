...
// function Home() {
// 	// State for the list of products and categories
// 	const [products, setProducts] = useState([])
// 	const [categories, setCategories] = useState([])
...
// 	const [name, setName] = useState("")
// 	const [description, setDescription] = useState("")
// 	const [price, setPrice] = useState("") // Use empty string for form fields
// 	const [quantity, setQuantity] = useState("")
// 	const [category, setCategory] = useState("") // Will hold the selected category ID

// 	// On component mount, fetch both products and categories
// 	useEffect(() => {
// 		getProducts()
// 		getCategories()
// 	}, [])
...
// 	const getCategories = () => {
// 		api.get("/api/categories/") // Your endpoint for categories
// 			.then((res) => setCategories(res.data))
// 			.catch((err) => alert(err))
// 	}
...
// 				if (res.status === 204) {
// 					alert("Product Deleted!")
// 					// Refresh products only after successful deletion
// 					getProducts()
// 				} else {
// 					alert("Failed to delete product.")
// 				}
...
// 	const createProduct = (e) => {
// 		e.preventDefault()
// 		// Send only the data the backend needs
// 		const productData = {
// 			name,
// 			description,
// 			price: parseFloat(price), // Convert price string to a float
